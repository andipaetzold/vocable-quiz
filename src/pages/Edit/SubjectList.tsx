                    ...
                    },
                    {
                        ...
                        render: (subject: Subject) => {
                            ...
                            return (
                                <>
                                    {cardsCount}{" "}
                                    <Popover title="Phases" content={<PhaseTimeline subject={subject} />}>
                    ...
                    },
                    {
                        ...
                        render: ({ id }) => (
                            <Button.Group size="small">
                                <Button type="primary" size="small" onClick={() => history.push(`/edit/${id}/create`)}>
                                    <Icon type="plus" /> <Trans i18nKey="create" />
                                </Button>
                                <Button size="small" onClick={() => history.push(`/edit/${id}`)}>
                                    <Icon type="edit" />
                                    <Trans i18nKey="edit" />
                                </Button>
                                <Popconfirm
